...
{
    public sealed class ResponseOrderQueryEntity : WechatResponseBaseEntity
    {
        ...
        [IsRequisiteParameter]
        [ParameterName("trade_state")]
        [ParameterMaxLength(16)]
        public TradeStateType TradeState { get; set; }
        ...
        [ParameterName("trade_state_desc")]
